...
<body>
	<div class="container_12">
		...
		<div class="grid_7">
			<h5> About </h5>
			<p> A reference library of preference data and links assembled by <a href="http://www.nickmattei.net">Nicholas Mattei</a> and <a href="http://www.cse.unsw.edu.au/~tw/">Toby Walsh</a>. We currently house over 3,000 datasets for use by the community.  We want to provide a comprehensive resource for the multiple research communities that deal with preferences, including computational social choice, recommender systems, data mining, machine learning, and combinatorial optimization, to name just a few. </p>

			<h5> Citation Policy </h5>
			<p> We ask that you provide a reference to our repository when publishing research based on data gathered here as this will allow other researchers to find us. Additionally, some of our datasets have citation policies specific to them, please comply with these requests. Many hours have been spent to gather, organize, and publish these datasets and we want to provide credit where credit is due.	
				<ul>
				<li> Mattei, Nicholas and Walsh, Toby. PrefLib: A Library of Preference Data. 
			...
			<p> Please contact <a href="http://www.nickmattei.net">Nicholas Mattei</a> via email at <b>nicholas{DOT}mattei@nicta.com.au</b> to contribute a data set. We will host the data set and work with you on keeping it up to date.  We rely on the support of the community in order to increase the usefulness and coverage of this site.  Please don't hesitate to contact us!
			</p> 			
		</div>
		...
		<div class="grid_8">
			<h5> Thanks!!! </h5>
			<p> PrefLib would not be possible without the support of the greater community.  We would like to specifically thank the following people for their contributions to PrefLib.</p>
			<ul>
		...
		<div class="grid_6">
			<center>
				<iframe src="http://www.seethestats.com/stats/8900/Visitors_8e1e57070_ifr.html" style="width:400px;height:210px;border:none;" scrolling="no" frameborder="0"></iframe>
			
				&nbsp;
			
				<iframe src="http://www.seethestats.com/stats/8900/Visits_5c3661e38_ifr.html" style="width:400px;height:210px;border:none;" scrolling="no" frameborder="0"></iframe>		
			<center>
		</div>
		<div class="grid_6">
			<center>
				<iframe src="http://www.seethestats.com/stats/8900/VisitsByRegion_7918a1638_ifr.html" style="width:400px;height:210px;border:none;" scrolling="no" frameborder="0"></iframe>
		
				&nbsp;
		
				<iframe src="http://www.seethestats.com/stats/8900/VisitsByCountry_6de274865_ifr.html" style="width:400px;height:210px;border:none;" scrolling="no" frameborder="0"></iframe>
			</center>
		</div>

	...
	<div class="container_12">
		...
		<div class="grid_7">
			...
			<h5> Data Categories</h5>
				...
				<ul>
					<li class='wide'><a href="source.php#ed">Election Data (ED):</a> This category contains data that either was an election, or can be interpreted as election data.  Generally speaking the sets are preference relations (votes) over a set of objects (candidates).  We have data from actual elections, movie rankings, and competitor rankings from various sporting competitions.</li>

					<li class='wide'><a href="source.php#md">Matching Data (MD):</a> This category contains data where agents express preference over items (and vise-verse) in order to pair agents to items.  We have synthetic data from organ and kidney matching in the USA as well as bidding data from large conferences.  We hope to obtain data in a variety of domains including two-sided matching markets such as residents bidding on hospitals and one-sided markets such as students bidding on dorm rooms.</li>

					<li class='wide'><a href="source.php#cd">Rating and Combinatorial Preference Data (CD):</a> This category contains data from a broad set of domains that can be viewed as combinatorial and/or multidimensional.  This includes		multi-attribute ratings, CP-nets, GAI-nets and lexicographical preferences for multi-attribute objects.</li>

					<li class='wide'><a href="source.php#od">Optimization Data (OD):</a> This category will contain data that is typically associated with optimization problems including SAT and CSP problems.  Currently we have no good data in this category and provide links to other libraries covering this type of data.</li>
				</p>
		...
		<div class="grid_8">
			<div class="news_box"><a name = "soc"></a>
		       	...
		       	<p>Each file with a <b>soc</b> extension contains a profile consisting of a complete, transitive, and asymmetric relation over a group of objects. These are written A,B,C; meaning that A is strictly preferred to B which is strictly preferred to C.  The strict relation is always denoted by use of a comma (,). <br><br> <a href="type.php#soc">Download all data files containing SOC data.</a> <br><br> <a href="#top">Top.</a> </p>
	        </div>
	       	...
	       	<div class="news_box"><a name = "soi"></a>
	       		...
	       		<p> Each file with a <b>soi</b> extension contains a profile consisting of a transitive and asymmetric relation over a group of objects. These are written A,B,C; meaning that A is strictly preferred to B which is strictly preferred to C. The strict relation is always denoted by use of a comma (,) and unranked elements are not included in the list of a particular agent. <br><br> <a href="type.php#soi">Download all data files containing SOI data.</a> <br><br> <a href="#top">Top.</a> </p> 
	       	</div>
	       	...
	       	<div class="news_box"><a name = "toc"></a>
	       		...
	       		<p> Each file with a <b>toc</b> extension contains a profile consisting of an transitive relation where all elements appear in every list. These written A,{B,C},D; meaning A is strictly preferred to {B,C}, while the voter is indifferent between B and C, with A,B, and C all preferred to D. The strict relation is always denoted by use of a comma (,) while elements that an agent is indifferent between are grouped in a curly brace ({}). <br><br> <a href="type.php#toc">Download all data files containing TOC data.</a> <br><br> <a href="#top">Top.</a> </p> 
	       	</div>
	       	...
	       	<div class="news_box"><a name = "toi"></a>
	       		...
	       		<p> Each file with a <b>toi</b> extension contains a profile consisting of an transitive relation where not all elements appear in every list. These written A,{B,C},D; meaning A is strictly preferred to {B,C}, while the voter is indifferent between B and C, with A,B, and C all preferred to D. The strict relation is always denoted by use of a comma (,) while elements that an agent is indifferent between are grouped in a curly brace ({}). <br><br> <a href="type.php#toi">Download all data files containing TOI data.</a> <br><br> <a href="#top">Top.</a> </p> 
	       	</div>
	       	...
	       	<div class="news_box"><a name = "tog"></a>
	       		...
	       		<p> Files with a <b>tog</b> extension describe a tournament graph. A tournament graph is a complete directed graph over a set of alternatives.  In our formatting we simply state the list of pairwise relations that describe the tournament (A,B; B,C). The strict relation is always denoted by use of a comma (,).  Note that tournaments must be complete assignment of the strict preference relation, otherwise it is a majority graph (see below). <br><br> <a href="type.php#tog">Download all data files containing TOG data.</a> <br><br> <a href="#top">Top.</a> </p> 
	       	</div>
	        ...
	        <div class="news_box"><a name = "pwg"></a>
	       	...
	       	<div class="news_box"><a name = "wmd"></a>
	       		...
	       		<p> Files with a <b>wmd</b> extension describe a set of weighted matching data. These are directed graphs where source is linked to the sink with a specified weight. <br><br> <a href="type.php#wmd">Download all data files containing WMD data.</a> <br><br> <a href="#top">Top.</a> </p> 
	       	</div> 
	        ...
	        <div class="news_box"><a name="wmatching-data"></a>
				...
				The edges are sorted by source so that all edges starting from the same source are grouped together. <br><br> <a href="source.php#md">See all the Matching Data (MD) data sets.</a> <br><br> <a href="#top">Top.</a> </p>
	        </div>
